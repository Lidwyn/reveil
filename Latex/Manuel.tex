...
Ceci fait, on peut sortir du monde de réglage de l'heure en appuyant sur le bouton setup \circled{\textbf{N}}.
...
\begin{enumerate}
    \item Les alarmes permanantes : sonne selon une période hebdommadaire.
    \item Les alarmes éphémmères : ne sonne qu'une seule fois puis se désarme.
\end{enumerate}

Il y a donc jusqu'à 15 de chaque et les deux types on leur page respective dans menu des réveils.
...
Si il s'agit d'une alarme éphémmère, elle se désactive automatiquement.
